...
{
    Cell *rowCells = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE);
...
{
    Cell *columnCells = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE);
    for (ubyte i = 0; i < SUDOKU_SIZE; i++)
    {
...
{
    Cell *blockCells = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE);
...
Cell *getBlockNotEmpty(ubyte bx, ubyte by, Cell *board, ubyte *length)
{
    ...
    Cell *notEmptyCells = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE);
...
{
    ubyte *values = (ubyte*) malloc(SUDOKU_SIZE);
    ubyte c = 0;
...
{
    Cell *emptyCells = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE * SUDOKU_SIZE);
    ubyte c = 0;
...
Cell *createBoard()
{
    Cell *board = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE * SUDOKU_SIZE);
...
{
    ubyte **result = (ubyte**) malloc(sizeof(ubyte *) * length);
    for (ubyte i = 0; i < length; i++)
    {
...
bool fillGrid(Cell *board)
{
    ...
    ubyte *validLengths = (ubyte*) malloc(emptyLength);
    ...
    ubyte *candidates = (ubyte*) malloc(candidatesLength);
...
{
    Cell *oldBoard = (Cell*) malloc(sizeof(Cell) * SUDOKU_SIZE * SUDOKU_SIZE);
